...
function TextField({
  ...
  const baseClassName = [
    "w-full rounded-xl align-middle placeholder:text-m3-on-surface-variant/70",
  ...
  return <input type={type} className={baseClassName} aria-invalid={invalid || undefined} {...props} />;
}
