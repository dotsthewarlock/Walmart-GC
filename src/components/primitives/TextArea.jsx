...
const densityClasses = {
  standard: "min-h-[96px] px-3.5 py-3 text-sm",
  compact: "min-h-[80px] px-3 py-2.5 text-xs",
};
...
function TextArea({
  ...
  const baseClassName = [
    "w-full rounded-xl align-middle resize-y placeholder:text-m3-on-surface-variant/70 leading-relaxed",
  ...
  return <textarea className={baseClassName} aria-invalid={invalid || undefined} {...props} />;
}
