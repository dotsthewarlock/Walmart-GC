...
However, several notable concerns must be resolved to ensure complete architectural cleanliness, long-term maintainability, and strict adherence to the [M3_DESIGN_DECISIONS.md](file:///home/godfreymiu/Walmart-GC/docs/M3_DESIGN_DECISIONS.md) guidelines:
1. **Orphaned shadcn Primitives**: The custom shadcn elements under [components/ui/](file:///home/godfreymiu/Walmart-GC/src/components/ui) are currently completely unimported and unused in the active source tree, with the app continuing to rely entirely on native tags with long, inline utility classes.
2. **M3 Design Divergences (Spotlight Scrim)**: The checkout spotlight focus backdrop utilizes a darkened modal-like overlay (`bg-black/60`) in [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1941) which violates the strict non-modal surface specification in [M3_DESIGN_DECISIONS.md](file:///home/godfreymiu/Walmart-GC/docs/M3_DESIGN_DECISIONS.md#L113).
3. **Hardcoded Development Context**: The system diagnostics container displays a hardcoded Git branch string `agy/shadcn-refactor-docs` in [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1683), displaying misleading runtime data to production users.
4. **Stale Assets and Guidelines**: Legacy, non-React files ([app.js](file:///home/godfreymiu/Walmart-GC/app.js) and [styles.css](file:///home/godfreymiu/Walmart-GC/styles.css)) are lingering in the root directory, while legacy prompt guidelines in [AGENTS.md](file:///home/godfreymiu/Walmart-GC/AGENTS.md) still reference cache-busting fingerprints.
...
* **Evidence**: File paths [badge.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/badge.jsx), [button.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/button.jsx), [card.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/card.jsx), and [input.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/input.jsx) exist but are never imported in [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx).
...
* **M3 or project-rule violation**: Violates the "Primitive Customization / Reusable Semantic Roles" rule in [ACTIVE_CONTEXT.md](file:///home/godfreymiu/Walmart-GC/docs/ACTIVE_CONTEXT.md#L100-L102) which requires utilizing local custom components to govern shape-rounding, touch targets, and consistent tonal palettes.
* **Suggested fixes**:
  1. *Complete Integration*: Replace raw native elements (buttons, inputs) in [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) with the matching `<Button>` and `<Input>` shadcn primitives, customizing them to support the 48px touch targets and correct color mapping.
...
* **Evidence**: [App.jsx:L1683](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1683):
  ```jsx
...
* **Recommended fix**: **Fix 2 (Remove Internal Row)**. Active Git branches are internal development telemetry. They are not actionable for normal users and should be omitted from the user-facing diagnostics card per [M3_DESIGN_DECISIONS.md](file:///home/godfreymiu/Walmart-GC/docs/M3_DESIGN_DECISIONS.md#L127).
* **Risk level**: Low
...
* **Evidence**: [App.jsx:L1941](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1941) in the spotlight focus markup:
  ```jsx
  className="fixed inset-0 bg-black/60 z-45 transition-opacity duration-300 cursor-pointer animate-fade-in"
  ```
* **M3 concern**: Direct violation of the strict non-modal focus specification in [M3_DESIGN_DECISIONS.md:L113](file:///home/godfreymiu/Walmart-GC/docs/M3_DESIGN_DECISIONS.md#L113), which specifies: *"The backdrop uses the default light surface background (`bg-m3-surface`) with no darkened scrim overlay (`bg-black/60` or similar) or backdrop blurring."* The current `bg-black/60` behaves as a heavy, desktop-style modal darkened overlay.
* **Suggested fixes**:
...
* **Evidence**: Duplicated absolute/translate divs in [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) on lines:
  - [App.jsx:L1378](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1378)
  - [App.jsx:L1392](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1392)
  - [App.jsx:L1406](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1406)
...
* **Suggested fixes**:
  ...
  2. *Adopt custom CSS classes*: Create an `.m3-switch` class set in [index.css](file:///home/godfreymiu/Walmart-GC/src/index.css) to encapsulate slider measurements and transitions.
...
* **Evidence**: [App.jsx:L1350](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1350):
  ```jsx
...
* **Single-File App.jsx Architecture**: [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) has ballooned to 2,150 lines. It encompasses the main App Shell, local offline state engine, Google Sync OAuth handling, CSV parsers, List View cards rendering, Settings forms, and Barcode spotlight focus overlays. This massive file size severely impacts readability and local navigation, although it keeps build paths simple.
* **Unused Legacy Root Files**: Unused legacy pre-React static assets ([app.js](file:///home/godfreymiu/Walmart-GC/app.js) and [styles.css](file:///home/godfreymiu/Walmart-GC/styles.css)) are sitting in the root project directory. Though explicitly marked in the [Maintenance Log](file:///home/godfreymiu/Walmart-GC/docs/MAINTENANCE_LOG.md#L82) as "deferred until production stability is established", they represent a continuous source of search noise and developer confusion.

---

## 5. Medium-concern items
* **Manual Button Tailwind Duplications**: Buttons in [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) (such as lines 1414, 1441, 1450, 1468, 1479, 1487) manually replicate a long string of focus-rings, scale transitions, and active animation behaviors (`transition-all active:scale-95 shadow-sm ... focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-m3-primary focus-visible:ring-offset-2`). They should be consolidated into a few reusable CSS classes in [index.css](file:///home/godfreymiu/Walmart-GC/src/index.css) (e.g., `.btn-m3-primary`, `.btn-m3-tonal`) or mapped directly using custom components.

---

## 6. Low-concern items
* **Agy-Handoff Script Execution Rule**: The handoff policy in [ACTIVE_CONTEXT.md](file:///home/godfreymiu/Walmart-GC/docs/ACTIVE_CONTEXT.md#L74) requires every terminal session to conclude by executing `~/Project/bin/agy-handoff` to update GitHub Issue #200. This is an excellent workflow habit but requires manual developer/agent diligence to avoid state drift.
* **Diagnostic Code Comments**: There are several scattered inline comments detailing old structural adjustments (e.g. [App.jsx:L1596](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1596) `{/* Data Panel / Backup Controls */}`) that could be cleaned up.
...
### File 1: AGENTS.md
* **Problem**: [AGENTS.md:L453-455](file:///home/godfreymiu/Walmart-GC/AGENTS.md#L453-455) contains rules requiring agents to bump cache-busting fingerprints in `index.html`, `app.js`, and `styles.css` upon edits.
* **Current source of truth conflict**: [ACTIVE_CONTEXT.md:L91-92](file:///home/godfreymiu/Walmart-GC/docs/ACTIVE_CONTEXT.md#L91-L92) and [PHASE_12_BEHAVIOR_INVENTORY.md:L20](file:///home/godfreymiu/Walmart-GC/docs/archive/PHASE_12_BEHAVIOR_INVENTORY.md#L20) explicitly state that dynamic fingerprint versioning is **deprecated** and replaced by Vite's standard hash bundle output (`dist/assets/index-[hash].js`).
* **Recommended cleanup**: Edit [AGENTS.md](file:///home/godfreymiu/Walmart-GC/AGENTS.md) to strip these old cache-busting guidelines and align with the standard local Vite compile workflow.
* **Action**: Update.
...
* **Recommended cleanup**: Add a prominent `> [!NOTE]` callout at the top of [GOOGLE_SHEET_SETUP.md](file:///home/godfreymiu/Walmart-GC/docs/GOOGLE_SHEET_SETUP.md) reminding developers that Apps Script sections are for archived historical context only.
...
| :--- | :--- | :--- | :--- |
| [app.js](file:///home/godfreymiu/Walmart-GC/app.js) | Pre-React static app main script (3,500+ lines). | **Archive** (Move to `docs/archive/legacy-code/`) | Highly confusing when searching for UI variables; completely unused by the active Vite build. |
| [styles.css](file:///home/godfreymiu/Walmart-GC/styles.css) | Pre-React static app stylesheet. | **Archive** (Move to `docs/archive/legacy-code/`) | Replaced by `src/index.css`. Contributes to text search noise. |
| [components/ui/badge.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/badge.jsx) | Unused shadcn primitive. | **Keep** | Reserved for future design polishing. |
| [components/ui/button.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/button.jsx) | Unused shadcn primitive. | **Keep** | Highly useful for future refactoring of App.jsx buttons. |
| [components/ui/card.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/card.jsx) | Unused shadcn primitive. | **Keep** | Ideal for standardizing container elevated layouts. |
| [components/ui/input.jsx](file:///home/godfreymiu/Walmart-GC/src/components/ui/input.jsx) | Unused shadcn primitive. | **Keep** | Necessary for clean text inputs in settings. |
...
* **Branch name variable in diagnostics**: The active Git branch value displays `agy/shadcn-refactor-docs` as a hardcoded static string in [App.jsx:L1683](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1683). This is outdated and misleading, and should be removed.
...
* **Shadcn Alignment**: Currently, custom shadcn configuration files exist ([components.json](file:///home/godfreymiu/Walmart-GC/components.json)) and primitive assets are installed under `src/components/ui/`, but they are entirely **orphaned**. This means the app fails to benefit from shadcn's standard accessibility roles, keyboard focus tracking, or transition classes.
...
* **Locked Checkout Decisions Compliance**:
  ...
  - Spotlight focus avoids modal/black-panel behavior → **Near-Miss / Minor Violation**: While the code spotlight focus container is styled inline inside the page flow, it still triggers a modal-like dark scrim (`bg-black/60`) on line 1941, violating the non-modal surface rule in [M3_DESIGN_DECISIONS.md](file:///home/godfreymiu/Walmart-GC/docs/M3_DESIGN_DECISIONS.md#L113).
...
* **Settings Placement**: The user's Google connection profile details (email/name) are strictly confined to the locked settings screen under the Google Sync Connection panel ([App.jsx:L1431](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1431)). This perfectly satisfies the privacy guardrail.
...
1. **Prune Stale Root Code**: Archive legacy static web files ([app.js](file:///home/godfreymiu/Walmart-GC/app.js) and [styles.css](file:///home/godfreymiu/Walmart-GC/styles.css)) into `docs/archive/legacy-code/` immediately to reduce text search noise and keep the active tree clean.
2. **Consolidate Switch Custom Controls**: Extract the duplicated slider markup into an inline `<Switch checked={...} onChange={...} />` component inside [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) to eliminate block redundancy.
3. **Establish Shared CSS Utility Roles**: Extract repetitive button/focus rings from [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) into clear CSS utilities in [index.css](file:///home/godfreymiu/Walmart-GC/src/index.css) (e.g. `.m3-btn-primary`, `.m3-btn-secondary-container`) to keep Tailwind classes manageable.
...
5. **Update AGENTS.md Guidelines**: Strip out-of-date static fingerprint instructions from the prompt guidelines in [AGENTS.md](file:///home/godfreymiu/Walmart-GC/AGENTS.md).
...
* **Files likely touched**:
  ...
  - [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) (Edit lines 1350, 1683)
  - [AGENTS.md](file:///home/godfreymiu/Walmart-GC/AGENTS.md) (Edit line 453)
...
* **Files likely touched**:
  - [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) (Edit lines 1370-1407, 1941)
...
* **Files likely touched**:
  - [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx)
  - [index.css](file:///home/godfreymiu/Walmart-GC/src/index.css)
...
2. **Active Guidelines Review**: Thoroughly inspected [docs/ACTIVE_CONTEXT.md](file:///home/godfreymiu/Walmart-GC/docs/ACTIVE_CONTEXT.md), [docs/M3_DESIGN_DECISIONS.md](file:///home/godfreymiu/Walmart-GC/docs/M3_DESIGN_DECISIONS.md), [docs/reference/M3_Core_Guidelines.md](file:///home/godfreymiu/Walmart-GC/docs/reference/M3_Core_Guidelines.md), [README.md](file:///home/godfreymiu/Walmart-GC/README.md), and [package.json](file:///home/godfreymiu/Walmart-GC/package.json).
3. **Source Tree Auditing**: Performed targeted grep checks on [src/App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) to scan for legacy strings, "reveal/hide" occurrences, custom switch slider duplication, and troubleshooting status elements.
...
1. **System Diagnostics Hardcoded Branch name**: Correct [App.jsx:L1683](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1683) by removing the active git branch indicator row to align with clean, noise-free Troubleshooting designs.
2. **Tabular Balances on List Items**: Add `font-mono` to the list item row balance span ([App.jsx:L1350](file:///home/godfreymiu/Walmart-GC/src/App.jsx#L1350)) to ensure right-aligned columns align cleanly with no layout drift.
3. **Archive Legacy Assets**: Move stale files [app.js](file:///home/godfreymiu/Walmart-GC/app.js) and [styles.css](file:///home/godfreymiu/Walmart-GC/styles.css) into a legacy-code archive subfolder to reduce search clutter.
...
1. **Single-File App.jsx Modular Refactoring**: Splitting the 2,150-line [App.jsx](file:///home/godfreymiu/Walmart-GC/src/App.jsx) into smaller modular files should be deferred until all core Material 3 design and visual component cleanup milestones are fully stabilized.
